...
public:
    ...
    void setVector4( const zpVector4fData& value );
    void setMatrix( const zpMatrix4fData& value );
    ...
    const zpVector4fData& getVector4() const;
    const zpMatrix4fData& getMatrix() const;
    ...
    zpVector4fData asVector4() const;
    zpMatrix4fData asMatrix() const;
...
private:
    ...
    union
    {
        ...
        zpVector4fData m_vector4;
        zpMatrix4fData m_matrix;
        zpColorf m_color;
